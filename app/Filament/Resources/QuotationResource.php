...
class QuotationResource extends Resource
{
    ...
    {
        return static::getModel()::where('document_type', 'quotation')->count();
    }
    ...
    protected static ?string $navigationBadgeTooltip = 'Total number of Quotation';
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        $query = parent::getEloquentQuery()
            ->where('document_type', 'quotation'); // Show only 'invoice' documents
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('document_date')->date()->sortable()->label('Date'),
